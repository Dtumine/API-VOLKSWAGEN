...
const API_AUTOS = 'https://TU_API_AUTOS.onrender.com/api/autos';
const API_EMPLEADOS = 'https://TU_API_EMPLEADOS.onrender.com/api/empleados';
const API_CLIENTES = 'https://TU_API_CLIENTES.onrender.com/api/clientes';
